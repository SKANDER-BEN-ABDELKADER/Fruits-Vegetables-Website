...
try {
    ...
    $email_err = ""; // Définition de la variable $email_err
    $mobile_err = ""; // Définition de la variable $mobile_err 
    ...
    if (isset($_POST['submit'])) {
        ...
        if ($stmt->rowCount() > 0) {
            ...
            // Vérification si le numéro de mobile existe déjà
            $mobile_check_query = "SELECT * FROM users WHERE mobile = :mobile";
            $stmt = $conn->prepare($mobile_check_query);
...
?>
    ...
    <div class="container py-5">
        <h1 class="mb-4" id="log">Register now !</h1>
        <form action="" method="POST">
            <div class="row g-5">
                <div class="col-md-6" id="form">
                    <div class="row">
                        <div class="col-md-12 col-lg-12">
                            <div class="form-item w-100">
                                <label for="fullname" class="form-label my-3">Full Name<sup>*</sup></label>
                                <input type="text" class="form-control" id="fullname" name="fullname" required>
                            </div>
                        </div>
                    </div>
                    <div class="form-item">
                        <label for="companyname" class="form-label my-3">Company Name<sup>*</sup></label>
                    ...
                    <div class="form-item">
                        <label for="pass" class="form-label my-3">Password<sup>*</sup></label>
                        <input type="password" class="form-control" id="pass" name="pass" required>
                    </div>
                </div>
                <div class="container">
                    <div class="col-lg-6">
                        <button type="submit" name="submit" class="btn btn-primary btn-lg custom-width" id="Submit" style="position: relative; left: 95%;">Submit</button>  
                    </div>
                </div>
            </div>
        </form>
