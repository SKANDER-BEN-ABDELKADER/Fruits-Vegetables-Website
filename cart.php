...
try {
    ...
    if(isset($_SESSION['user_id'])) {
        ...
        $stmt = $conn->prepare("SELECT products.*, cart.quantity AS cart_quantity FROM products INNER JOIN cart ON products.id = cart.product_id WHERE cart.user_id = :userId");
