...
// Function to get the count of products for each category
function getProductCount($conn, $category)
{
    $query = "SELECT COUNT(*) as count FROM products WHERE type='$category'";
...
if ($filter == 'all') {
    $query = "SELECT id, name, type, price, descr, image FROM products LIMIT $start, $itemsPerPage";
} else {
    $query = "SELECT id, name, type, price, descr, image FROM products WHERE type='$filter' LIMIT $start, $itemsPerPage";
}
$result = mysqli_query($conn, $query);

// Count the number of fruits and vegetables
$fruitsCount = getProductCount($conn, 'fruits');
$vegetablesCount = getProductCount($conn, 'vegetables');
        ...
        echo '<div class="col-md-6 col-lg-6 col-xl-4">
                <div class="rounded position-relative fruite-item">
                    <div class="fruite-img">
                        <img src="' . $image . '" class="img-fluid w-100 rounded-top" alt="" style="width: 200px; height: 220px;">
                    </div>
